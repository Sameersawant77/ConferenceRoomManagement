            ...
            <tr>
                ...
                <td>
                    <c:if test="${booking.status == 'cancelled'}">
                        <form action="ReBookServlet" method="post">
                            <input type="hidden" name="bookingId" value="${booking.bookingId}">
                            <button type="submit" class="btn btn-success btn-sm">Book Again</button>
                        </form>
                    </c:if>
                    <c:if test="${booking.status != 'cancelled'}">
                        <form action="ReBookServlet" method="post">
                            <button type="submit" class="btn btn-success btn-sm" disabled>Book Again</button>
                        </form>
                    </c:if>
                </td>
            </tr>
