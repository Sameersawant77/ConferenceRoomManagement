                ...
                <div class="col">
                    <div class="card h-100 room-card">
                        ...
                        <div class="card-body">
						    ...
						    <p class="card-text">Amenities: ${room.amenities}</p> <!-- Added amenities display -->
	            ...
	            <div class="modal-body">
	                <form action="RoomCrudServlet" method="post">
	                    ...
	                    <div class="mb-3">
	                        ...
	                        <input type="text" class="form-control" id="amenities" name="amenities" placeholder="Enter amenities, comma separated">
	                    </div>
